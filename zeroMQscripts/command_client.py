...
class CommandClient:
    ...
    def __init__(self, server_ip="10.102.225.181", cmd_port=5556):
        ...
        connect_addr = f"tcp://{server_ip}:{cmd_port}"
        logger.info(f"Connecting to server at {connect_addr}")
        self.push_socket.connect(connect_addr)
    ...
    def stop_client(self):
        """Stop the command client (for joystick compatibility)"""
        pass  # No special cleanup needed for PUSH socket
